...
class Covid19Dataset_valid(Dataset):
    ...
    def __getitem__(self, index):
        ...
        start_idx,end_idx=self.test_dic[img_path][0],self.test_dic[img_path][1]
        ...
        if ct_len==1:
            ...
            sample_idx = self.test_dic[img_path][3]
...
weights_path_list=['/ssd2/ming/2024COVID/model/auc_roc/job_58_effb7_size384_challenge[DataParallel]-fold1.bin0.9824418048946397',
              '/ssd2/ming/2024COVID/model/auc_roc/job_61_effb7_size384_challenge[DataParallel]-fold1.bin0.9770150725466737',
              '/ssd2/ming/2024COVID/model/auc_roc/job_60_effb7_size384_challenge[DataParallel]-fold1.bin0.98071111710569',
              '/ssd2/ming/2024COVID/model/auc_roc/job_60_effb7_size384_challenge[DataParallel]-fold1.bin0.9806964362787085',
              '/ssd2/ming/2024COVID/model/f1/job_60_effb7_size384_challenge[DataParallel]-fold1.bin0.9361715971641709']
for j in range(5):
